    ...
    <section className="w-full bg-white overflow-hidden">
      <div className="flex flex-col md:flex-row md:min-h-[600px] lg:min-h-[650px]">
        ...
        >
          ...
          <m.div variants={itemVariants} className="absolute hidden md:flex right-8 top-8 lg:right-16 lg:top-12 items-center gap-3 text-[13px] font-medium tracking-widest text-gray-800">
          ...
          <div className="max-w-[480px]">
            <m.h2 variants={itemVariants} className="mb-3 md:mb-5 text-[26px] sm:text-[32px] md:text-[36px] lg:text-[40px] leading-[1.15] font-serif text-[#092119]">
              Tournament Style at The Mutua Madrid Open
            </m.h2>
            <m.p variants={itemVariants} className="mb-6 md:mb-9 text-[15px] leading-[1.5] text-[#333] md:text-[#0a2319]">
            ...
            <m.div variants={itemVariants} className="flex flex-row gap-3 w-full">
