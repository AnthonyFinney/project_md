        ...
        <div className="mt-4 flex flex-col gap-3">
          {type === "checkbox" &&
            options.map((option) => (
              ...
              >
                <div className="relative flex h-5 w-5 items-center justify-center rounded border border-gray-300 group-hover:border-black transition-colors">
                  <input
                    type="checkbox"
            ...
            <div className="grid grid-cols-4 gap-3">
              {options.map((option) => (
                ...
                >
                  ...
                  />
                  <span className="text-[10px] text-gray-500 group-hover:text-gray-900 max-w-full truncate px-1 text-center w-full">
                    {option.label}
                  </span>
                </button>
              ))}
  ...
  return (
    <div className="w-full pr-8">
      <div className="flex items-center justify-between border-b border-black pb-4 mb-2">
        ...
        <button className="text-[13px] text-gray-500 hover:text-black underline underline-offset-2">
          Clear all
        </button>
      </div>
