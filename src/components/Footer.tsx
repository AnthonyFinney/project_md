    ...
    <footer className="w-full bg-[#0a2319] text-white">
      ...
      <div className="mx-auto w-full max-w-[1440px] px-5 sm:px-6 lg:px-12">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between py-10 lg:py-12 border-b border-white/10 gap-6 md:gap-0">
          ...
          <div className="flex w-full md:w-auto gap-3 sm:gap-4 mt-2 md:mt-0">
      ...
      <div className="border-b border-white/10">
        <div className="mx-auto grid w-full max-w-[1440px] grid-cols-2 gap-y-10 gap-x-4 px-5 py-10 sm:px-6 lg:px-12 md:flex md:flex-nowrap md:justify-between md:py-12">
          <div className="flex flex-col items-center gap-3 md:w-1/4 text-center">
      ...
      <div className="border-b border-white/10">
        <div className="mx-auto flex w-full max-w-[1440px] flex-col lg:flex-row">
          {/* Newsletter Column */}
          <div className="w-full border-b border-white/10 p-6 sm:p-8 lg:w-[28%] lg:border-b-0 lg:border-r lg:p-12">
          ...
          <div className="flex w-full flex-col justify-between border-b border-white/10 p-6 sm:p-8 lg:w-[54%] lg:border-b-0 lg:border-r lg:p-12">
          ...
          {/* Socials Column */}
          <div className="flex w-full flex-row flex-wrap lg:flex-col gap-5 p-6 sm:p-8 lg:w-[18%] lg:p-12">
            <Link
              href="#"
      ...
      {/* Giant LACOSTE Text */}
      <div className="flex w-full justify-center overflow-hidden bg-[#0a2319] py-6 lg:py-8">
      ...
      <div className="w-full bg-white py-6">
        <div className="mx-auto flex w-full max-w-[1440px] flex-col items-center justify-between px-5 text-[11px] font-medium text-gray-500 lg:flex-row sm:px-6 lg:px-12">
          <div className="mb-5 flex flex-wrap justify-center gap-4 sm:gap-6 lg:mb-0 text-center">
