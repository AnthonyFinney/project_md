...
const products = [
  ...
  },
  {
    ...
    price: 125.0,
    imageUrl:
      "https://images.unsplash.com/photo-1618517351616-38fb9c52e0c6?q=80&w=800&auto=format&fit=crop",
    colors: ["#f3f4f6"],
  },
  {
    id: "p9",
  ...
  },
  {
    ...
    price: 35.0,
    imageUrl:
      "https://images.unsplash.com/photo-1620799140408-edc6d4c74f9d?q=80&w=800&auto=format&fit=crop",
    colors: ["#9ca3af", "#000"],
  },
  {
    id: "p13",
    ...
    <main className="min-h-screen">
      ...
      <div className="max-w-[1600px] mx-auto px-6">
        ...
        <div className="flex items-center gap-6 py-4 text-[14px] font-medium text-gray-800 border-b border-transparent">
          <Link
            href="/men"
            className="flex items-center gap-2 hover:text-black hover:underline underline-offset-4"
          >
        ...
        <div className="pt-4 pb-6">
          <h1 className="text-[28px] md:text-[36px] font-serif text-gray-900 leading-none">
            Men's New Arrivals
          </h1>
        </div>
          ...
          <div className="flex-1 w-full lg:pl-8">
            <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-x-6 gap-y-10 auto-rows-max">
              ...
              <div className="col-span-2 relative group overflow-hidden cursor-pointer bg-[#ececec] flex flex-col justify-end p-8">
                ...
                <div className="relative z-10 text-white">
                  <h3 className="text-[24px] font-serif mb-2">
                    The Tennis Collection
                  </h3>
                  <span className="text-[14px] underline underline-offset-4 font-medium hover:text-gray-200 transition-colors">
                    Discover
                  </span>
                </div>
              </div>
            ...
            <div className="mt-20 flex flex-col items-center justify-center border-t border-gray-200 pt-12">
              <p className="text-[14px] text-gray-500 mb-6">
                You've viewed 20 of 842 products
              </p>
